...
class RssSource extends DataSource {
	...
	function __readData() {
		...
		if ( !$data ) {
			//cottonj
			ini_set("user_agent","Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.168 Safari/535.19");
			$data = Set::reverse(Xml::build($feedUrl));
